...
function generarTablasYQR() {
  ...
  for (let i = serieInicial; i <= serieFinal; i++) {
    ...
    const textoQR =
      ...
      "|No. de Serie:" +
      i +
      "|Sistema de Sujecion: Red de carga 2.35 x 1.20 M C/ 3 Matracas y 6 Broches tipo E|Capacidad de Carga : 4,000 LBS|Uso preventivo:No exponer a Acidos y Superficies con filo|";
