...
function generarTablasYQR() {
    ...
    for (let i = serieInicial; i <= serieFinal; i++) {
      ...
      const textoQR =
        ...
        "|Region:"+
        region.value +
        "|Red de Carga 2\"(6,000 lbs) X 2.55 X .94 m C/ 2 Matracas y 4 broches tipo E|Capacidad de Carga : 4,000 LBS|Uso preventivo : No exponer a Acidos y Superficies con filo|";
