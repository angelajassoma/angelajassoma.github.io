...
function generarTablasYQR() {
    ...
    for (let i = serieInicial; i <= serieFinal; i++) {
      ...
      const textoQR =
        ...
        "|No. de Serie:" +
        i +
        "|Sistema de Sujecion: Red de carga 2.15 x 2.10 M C/ 4 Matracas y 8 Broches tipo E|Capacidad de Carga : 4,000 LBS|Uso preventivo:No exponer a Acidos y Superficies con filo|";
